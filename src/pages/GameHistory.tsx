  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="keywords" content="chess, chess board, chess online, chess board setup, online chess, chess game, chess pie, how to play chess, chess game history, past chess games, chess match records, chess game results, chess wins and losses, chess game tracking, review chess games, chess gameplay history, chess game archive, chess match analysis, chess performance tracker, chess statistics" />
