  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="keywords" content="chess, chess board, chess online, chess board setup, online chess, chess game, chess pie, how to play chess, chess leaderboards, chess rankings, top chess players, chess leaderboard, chess ratings, chess points, chess champions, competitive chess, chess rank, chess standings, chess elo rankings, best chess players online, chess rating system, chess player stats, chess competition rankings" />
