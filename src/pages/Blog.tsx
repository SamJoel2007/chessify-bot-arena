  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="keywords" content="chess, chess board, chess online, chess board setup, online chess, chess game, chess pie, how to play chess, chess blog, chess tips, chess strategy, chess articles, learn chess, chess guides, chess openings guide, chess tactics tutorial, chess endgame tips, chess improvement, master chess, chess game analysis articles, chess news, chess lessons online, chess training tips, chess strategy guides, chess opening theory" />
