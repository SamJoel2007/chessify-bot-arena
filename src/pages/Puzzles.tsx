  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="keywords" content="chess, chess board, chess online, chess board setup, online chess, chess game, chess pie, how to play chess, chess puzzles, mate in 1, mate in 2, mate in 3, chess tactics, chess tactics trainer, puzzle difficulty levels, improve chess tactics, chess pattern recognition, chess training puzzles, beginner chess puzzles, intermediate chess puzzles, advanced chess puzzles, expert chess puzzles, chess puzzle solver, daily chess puzzle, chess checkmate patterns, chess calculation practice, chess brain teasers, tactical chess exercises, chess problem solving" />
