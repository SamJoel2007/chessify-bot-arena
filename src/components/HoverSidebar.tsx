...
export function HoverSidebar({ user, currentAvatar }: HoverSidebarProps) {
  ...
  return (
    ...
    >
      {/* Hover trigger area */}
      <div className="absolute top-0 left-0 w-20 h-20 z-50" />
      
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-screen w-72 bg-card border-r border-border shadow-2xl z-40 transition-transform duration-300 ease-in-out ${
